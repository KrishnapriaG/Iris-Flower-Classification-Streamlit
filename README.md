...
```bash
git clone https://github.com/KrishnapriaG/Iris-Flower-Classification-Streamlit.git
```

Move into the project folder:

```bash
cd Iris-Flower-Classification-Streamlit
```
...
You can add screenshots of the application here after running the project.
